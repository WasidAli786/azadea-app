...
export function BookmarkBorderIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
...
export function OutlineKeyboardArrowLeft(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export function OutlineKeyboardArrowRight(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
